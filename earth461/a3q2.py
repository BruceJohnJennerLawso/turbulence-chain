...
if(__name__ == "__main__"):
	...
	graphLin("Apparent Conductivity by Plume conductivity", "plume2.png", "Apparent Conductivity (mS/m)", "Plume Conductivity (mS/m)", 0, 150, 0, 53, True, datasetA, datasetB, datasetC, datasetD, datasetE, datasetF)
